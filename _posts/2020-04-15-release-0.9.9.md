...
The development has been brief but intense. There are plenty of announces to make, some of great importance. Especially remarkable is the new map ingestion proccess. This has been simplified for users to use their maps in CARLA out-of-the-box. Traffic lights, and traffic will nevermore be added manually. CARLA is now able to manage OpenDRIVE signals as landmark objects. Traffic lights, stops and yields will be generated in the simulation automatically, based on the OpenDRIVE information.  
...
*   __[Upgrade to UE4.24.](#upgrade-to-ue4.24)__ Those working with a build from source have to upgrade to the latest UE version.  
*   __[Automatized map ingestion.](#automatized-map-ingestion)__ The process to ingest assets is simpler than ever. As for maps, it has been simplified to need barely none user interaction.  
...
*   __[RSS full-road integration.](#rss-full-road-integration)__ The integration of RSS is now operative on the whole road network. The _stay on road_ feature guarantees that RSS vehicles will not go off the road.  
*   __[Hybrid physics in Traffic Manager.](#hybrid-physics-in-traffic-manager)__ The module can disable unnecessary physics far from an ego vehicle. This saves up a lot of calculations, and improves performance greatly. 
*   __[OpenDRIVE mesh generation refined.](#opendrive-mesh-generation-refined)__ A smoothing preprocess is applied at junctions to fix imperfections. Furthermore, pedestrian navigation includes crosswalks, and safety measures have been added to prevent vehicles from falling off.  
*   __[PTV-Vissim co-simulation.](#ptv-vissim-co-simulation)__ The CARLA ecosystem expands to integrate PTV-Vissim. CARLA can run a synchronous simulation with PTV-Vissim in a similar way it does with SUMO. 
...
*   __[New tutorials.](#new-tutorials)__ A holistic tutorial about how to retrieve data will help users exploit CARLA at maximum. Besides that, the assets tutorials have been revisited, to facilitate the ingestion of self-created assets. 
*   __[Town10 HD premiere.](#town10hd-premiere)__ A completely new CARLA map. The spearhead in CARLA's orientation towards visual realism.  
