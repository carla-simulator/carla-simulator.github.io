...
{% include youtube.html id="Cl_8yERGIw8" %}
...
__Connectivity with ROS 2__ is now __natively supported__ by the CARLA server, abolishing the need for a bridge tool, brining lower latency connection with ROS nodes for smoother simulations.
