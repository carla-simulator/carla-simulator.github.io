...
In this release there has been a big focus on improving __determinism__, which the goal of
...
* __[Map Sublevels](#map-sublevels)__ -  We created new optimized versions of our maps (tagged with the "Otp" suffix) that can be loaded and
  unloaded in a layer-by-layer fashion.
...
* __[Deterministic Rag Doll animations](#deterministic-rag-dolls)__ -  Pedestrian-vehicle collisions are deterministic by default.
...
* __[Scenic Integration (Beta)](#scenic-integration-beta)__ - Support for  Scenic, a domain-specific traffic scenario language capable of
generating challenging traffic situations in a few lines of code.
...
(identified with the suffix "Otp") have the same layout as previous ones but they are now divided
into sublevels. This
...
<div class="alert alert-warning">
  <small><i><strong>Warning! </strong>Sublevels are only available in the "Otp" prefixed maps</i></small>
</div>
