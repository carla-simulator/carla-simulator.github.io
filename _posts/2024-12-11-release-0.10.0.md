...
To exploit the new capabilities delivered by the engine upgrade, 0.10.0 comes with **upgraded environments and assets** with a **upgraded Town 10** and **beautifully remodeled vehicles** along with a spectacular off-road **open-cast mine map** generously provided by CARLA's sponsor and consortium member [**Synkrotron**](https://www.synkrotron.ai/). 
