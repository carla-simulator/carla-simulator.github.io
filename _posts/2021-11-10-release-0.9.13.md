...
Continued improvement of the useability of the CARLA Python API comes with access to the Python version 3.9 version of the library for Linux and Windows, available through the convenient PIP package manager. 
