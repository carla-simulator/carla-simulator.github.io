...
This release comes with major improvements to the traffic manager, with new logic to promote [__more realistic vehicle behavior at intersections and at high speeds__](#improved-traffic-manager-logic). The API now offers new functionality to guide vehicles with a __user defined route or path__ and __vehicle lights__ now react to weather conditions and junctions. [__Vehicle physics__](#Improved-vehicle-behavior) has been enhanced with more accurate models of acceleration, gear and braking behaviour.

[__Installation improvements:__](#python-library-updates) following a continued commitment to improve the useability of the CARLA simulator a new wheel for the core CARLA API library is now available for Python version 3.9.
...
Continuing to improve the useability of the CARLA Python API, a wheel for the CARLA Python API package is now available for Python version 3.9 for Linux and Windows.
