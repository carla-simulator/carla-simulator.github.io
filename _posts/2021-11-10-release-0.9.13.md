...
Continued improvement of the useability of the CARLA Python API comes with the availability of a new wheel for Python version 3.9 for Linux and Windows.
