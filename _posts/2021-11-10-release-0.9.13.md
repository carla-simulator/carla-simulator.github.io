...
![instance_semantic_segmentation](/img/posts/2021-11-07/instance_segmentation.png){:class="img-fluid rounded mx-auto d-block"}
...
The CARLA garage has built an exciting new vehicle, a high fidelity version of the __Volkswagen T2 2021__. Add some charm to your city traffic with this beautifully retro styled vehicle. 
...
## Improved Vehicle Behavior - acceleration, gears and braking
