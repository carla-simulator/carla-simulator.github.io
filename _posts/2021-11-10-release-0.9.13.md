...
[__Installation improvements:__](#python-library-updates) following a continued commitment to improve the useability of the CARLA simulator a new wheel for the core CARLA API library is now also available for Python version 3.9.
