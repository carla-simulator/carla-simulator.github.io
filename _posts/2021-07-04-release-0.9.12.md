...
Here's a rundown of the features that come with CARLA 0.9.12:

- [__Large Maps__](#large-maps)
- [__Physics Determinism and Improvements__](#physics-determinism-and-improvements)
- [__OpenStreetMaps__](#openstreetmaps)
- [__Unreal Engine 4.26__](#unreal-engine-426)
- [__RLlib Integration__](#rllib-integration)
- [__Optical Flow Camera__](#optical-flow-camera)
- [__New and Improved Vehicles__](#new-and-improved-vehicles)
- [__New and improved pedestrians__](#new-and-improved-pedestrians)
- [__Chrono Integration (Beta)__](#chrono-integration-beta)
- [__Python Client Library__](#python-client-library)
- [__spawn_npc.py Rename__](#spawn_npcpy-rename)
- [__New default town__](#new-default-town)
...
Large maps are constructed from many tiles, each with a maximum size of 2km x 2km. Tiles are streamed in and out of the simulation according to their distance from the hero vehicle. The streaming distance is configurable through the Python API.
...
We have added five new vehicles to the CARLA blueprint library. Introducing the:
...
Actors in the blueprint library now have an additional generation attribute to distinguish between old and new models when you spawn them. You can also set a flag in `generate_traffic.py` and `manual_control.py` that defines which generations you would like to spawn:
...
GitHub repositories during the development of CARLA 0.9.12. Thanks a lot for your hard work!
