...
*   __[Enhanced vehicle physics](#enhanced-vehicle-physics)__ — Changes in the core physics result in stable turns, and sensible responses to collisions.  
...
We have worked on the physics asssets of the vehicles so that their volumes are more accurate, and the core physics (such as center of mass, suspension, wheel's friction...) are more realistic. The result is more noticeable whenever a vehicle turns or collides with another object. The balance of the vehicle is much greater now. The response to commands and collisions is no longer over-the-top, but restrained in favor of realism.  
...
- [jbmag](https://github.com/fgolemo)  
