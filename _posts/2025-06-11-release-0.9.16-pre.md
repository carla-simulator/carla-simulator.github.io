...
Some of the upcoming features have already been merged into CARLA! Download the nightly build right now using the link below and dive right in!

<p class="center">
  <a href="https://carla-releases.s3.us-east-005.backblazeb2.com/Linux/Dev/CARLA_Latest.tar.gz" target="_blank" class="btn btn-primary" title="Go to CARLA releases" style="text-decoration: none;">
    Download CARLA Nightly build with NuRec
  </a>
</p>
...
We’re also introducing **experimental support for NVIDIA NuRec 25.07**, a state-of-the-art neural rendering pipeline.
