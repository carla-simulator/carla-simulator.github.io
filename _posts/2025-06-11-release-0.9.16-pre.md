...
Some of the upcoming features have already been merged into CARLA! You download the nightly build right now using the link below and dive right in!
...
The neural reconstruction tool is already integrated into the CARLA development branch! You can try it right now by downloading the nightly build below!

<p class="center">
  <a href="https://carla.readthedocs.io/en/latest/download/" target="_blank" class="btn btn-primary" title="Go to CARLA releases" style="text-decoration: none;">
    Download CARLA with NUREC
  </a>
</p>
