...
Finally, you could use these distribution packages in the CARLA distribution packages by simply moving them to the CARLA `Import` folder and executing the `ImportAssets.sh` script.
