...
{% include youtube.html id="YLh07d-YPSI" %}
...
We are thrilled to present to you the __CARLA 0.9.16 release__! This version brings some major upgrades to the __Unreal Engine 4.26 version__ of CARLA that promise to augment your CARLA workflow and enhance the diversity of your simulation data! 
...
![vulnerable_road_users](/img/posts/2025-09-16/vru_pedestrians.webp){:class="img-fluid rounded mx-auto d-block"}
